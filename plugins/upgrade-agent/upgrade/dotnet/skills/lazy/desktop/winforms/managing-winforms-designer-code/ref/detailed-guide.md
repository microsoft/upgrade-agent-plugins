...
- ❌❌❌ Static Factory methods for resources. Those are really problematic:
    They might appear to work in a quick test, but after a Designer round-trip they are
    quietly dropped. They usually do not cause a deserialization error, but they also
